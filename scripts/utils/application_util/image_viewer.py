...
class ImageViewer(object):
    ...
    * 'ESC' : quit
    ...
    def rectangle(self,idx, video, x, y, w, h, label=None, loc=None, thread=None, thickness=None):
        """Draw a rectangle.
        ...
        if self._color == (128,0,0):
            ...
            cv2.rectangle(self.image, pt1, pt2, self._color, thickness)
        ...
        if label is not None:
            ...
            pt2 = pt1[0] + 10 + text_size[0][0], pt1[1] + 10 + \
                text_size[0][1]
            cv2.rectangle(self.image, pt1, pt2, self._color, thickness)
            if thickness is not -1:
                cv2.putText(self.image, label, center, cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0), 1)
